        ...
        function optionHtml($tmpSelectOptions)
        {
            ...
            $tmpSelectOptions.each(function(i) {
                if ($(this).css("display") != "none") {
                    htmlStr += " <div class='slide-item' xvalue='" + $(this).attr("value") + "' class='forOption'><span style='text-align:left;' lang=\"en\">" + $(this).html() + "</span></div>";
                }
            });
            return htmlStr;
        }
