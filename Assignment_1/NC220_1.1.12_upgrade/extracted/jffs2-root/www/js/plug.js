var valid = {
	...
	cameraname: function(a) {
		//var b = /^(([\u4e00-\u9fa5a-zA-Z0-9\.\-\_\'\@]\ ?)*([\u4e00-\u9fa5a-zA-Z0-9\.\-\_\'\@])){1,30}$/;
		//var b = /^*{1,64}$/;
...
var plug = {
	...
	button: {
		init: function(a) {
			a.find("input[type='button']").each(function() {
				$(this).attr("disabled") && plug.button.disable($(this))
			})
		},
		disable: function(a) {
			var b = a.attr("id");
			return b ? (document.getElementById(b).style.cssText = "background:url('/images/button-disable.png') repeat-x !important;color:#A6A6A6;border:1px solid #BFBFBF", a.attr("disabled", !0), void 0) : !1
		},
		enable: function(a) {
			var b = a.attr("id");
			return b ? (document.getElementById(b).style.cssText = "background:url('/images/button.png') repeat-x;color:#4D4D4D;border:1px solid #BFBFBF", a.attr("disabled", !1), void 0) : !1
		}
	},
	window: {
		alert: function(a) {
		...
		beforeInit: function(a) {
			...
			if (typeof common != "undefined") {
				common.mdPlayerWidth.width = $("#mdplugin").width();
				common.mdPlayerWidth.height = $("#mdplugin").height();					
			} 		 		
		...
		afterCancel: function(){
			if (typeof common != "undefined") {
				$("#tpplugin").css({
					width: common.playerWidth.width,
					height: common.playerWidth.height
				});
				$("#mdplugin").css({
					width: common.mdPlayerWidth.width,
					height: common.mdPlayerWidth.height
				});				
			} 		 	
			//a.afterCancel();
		},
	...
	getWheelDelta: function(a) {
		return a.wheelDelta ? a.wheelDelta : 40 * -a.detail
	}
};